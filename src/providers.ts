...
export const PROVIDERS: ProviderConfig[] = [
  ...
  },
  {
    ...
    authType: 'cli-login',
    setupCommand: 'ollama launch codex',
...
export const DEFAULT_MODELS: ModelOption[] = [
  ...
  // Curated from Ollama's Claude Code/OpenClaw docs and cloud launches.
  {
    ...
    provider: 'ollama',
    description: 'Verified working through Ollama + Codex on this Mac',
    command: 'ollama launch codex --model minimax-m2.7:cloud',
  },
  {
    id: 'ollama-glm-5',
    name: 'GLM-5 (Ollama Cloud)',
    provider: 'ollama',
    description: 'Cloud launch candidate through Ollama + Codex',
    command: 'ollama launch codex --model glm-5:cloud',
  },
  {
    id: 'ollama-kimi-k2.5',
    ...
    provider: 'ollama',
    description: 'Cloud launch candidate through Ollama + Codex',
    command: 'ollama launch codex --model kimi-k2.5:cloud',
  },
  {
    id: 'ollama-qwen3.5',
    name: 'Qwen 3.5 (Ollama Cloud)',
    provider: 'ollama',
    description: 'Official Ollama cloud variant for the larger Qwen 3.5 release',
    command: 'ollama launch codex --model qwen3.5:397b-cloud',
  },
  {
    ...
    command: 'ollama launch codex --model qwen3-coder:480b-cloud',
  },
  {
    ...
    provider: 'ollama',
    description: 'Cloud launch candidate through Ollama + Codex',
    command: 'ollama launch codex --model qwen3-coder-next:cloud',
  },
  {
    ...
    provider: 'ollama',
    description: 'Cloud launch candidate through Ollama + Codex',
    command: 'ollama launch codex --model deepseek-v3.2:cloud',
  },
  {
    id: 'codex-default',
    name: 'Codex (GPT-5)',
