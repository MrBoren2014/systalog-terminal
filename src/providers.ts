...
export const PROVIDERS: ProviderConfig[] = [
  ...
  },
  {
    ...
    icon: '🦙',
    color: '#f2a33b',
    description: 'Ollama launch workflow for local + cloud models',
    authType: 'cli-login',
    setupCommand: 'ollama launch claude',
...
export const DEFAULT_MODELS: ModelOption[] = [
  ...
  // Curated from Ollama's Claude Code/OpenClaw docs and cloud launches.
  {
    id: 'ollama-minimax-m2.7',
    name: 'MiniMax M2.7 (Cloud)',
    provider: 'ollama',
    description: 'Latest OpenClaw docs pick for fast coding + productivity',
    command: 'ollama launch claude --model minimax-m2.7:cloud',
  },
  {
    id: 'ollama-glm-5',
    name: 'GLM-5 (Ollama Cloud)',
    provider: 'ollama',
    description: 'Ollama cloud route for Zhipu GLM-5',
  ...
  },
  {
    ...
    provider: 'ollama',
    description: 'Ollama cloud route for Moonshot Kimi K2.5',
  ...
  },
  {
    ...
    provider: 'ollama',
    description: 'Official Claude Code recommendation from Ollama docs',
    command: 'ollama launch claude --model qwen3.5:cloud',
  },
  {
    id: 'ollama-qwen3-coder',
    name: 'Qwen3 Coder 480B (Cloud)',
    provider: 'ollama',
    description: 'Cloud coding model from Ollama library',
  ...
  },
  {
    ...
    provider: 'ollama',
    description: 'Verified cloud launch for Qwen3 Coder Next',
    command: 'ollama launch claude --model qwen3-coder-next:cloud',
  },
  {
    id: 'ollama-deepseek-v3.2',
    name: 'DeepSeek V3.2 (Cloud)',
    provider: 'ollama',
    description: 'Verified DeepSeek cloud route from Ollama library',
    command: 'ollama launch claude --model deepseek-v3.2:cloud',
  },
  {
    id: 'codex-default',
    name: 'Codex (GPT-5)',
